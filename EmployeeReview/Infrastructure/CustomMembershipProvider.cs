  ...
  public class CustomMembershipProvider : MembershipProvider
        {
            ...
            public override MembershipUser CreateUser(string email, string password,string fname,  string passwordQuestion, string passwordAnswer, bool isApproved, object providerUserKey, out MembershipCreateStatus status)
            {
                ...
                if (user == null)
                {
                    var userObj = new User { Email= email, Password = GetMd5Hash(password), Fname= fname };
